class DropboxController {
  ...
  connectFirebase() {
    ...
    var firebaseConfig = {
        ...
        appId: "1:433019358246:web:b3a7426907a2a890c66ae7",
        measurementId: "G-7C0LY4RJ96"
    };
    // Initialize Firebase
  ...
  initEvents() {
    ...
    this.inputFilesEl.addEventListener('change', event => {
      ...
      // Disabilita o botão de envio até o processo ser concluido
      ...
      this.uploadTask(event.target.files).then(responses => {
        ...
        responses.forEach(resp => {
          ...
          // Salva os dados da referencia do arquivo que realizou upload no firebase realtime database
  ...
  // Método para zerar o formulário e etc
  uploadComplete() {
  ...
  // Método que tratará o tipo do icone
  ...
  // Método para retornar o html com o icone do tipo do arquivo que subiu
  getFileView(file, key) {
    ...
    // Método que insere um evento ao item do li
  ...
  readFiles() {
    ...
    this. getFirebaseRef().on('value', snapshot => {
      ...
      // Limpa a tag UL que recebe os arquivos na tela
      this.listFilesEl.innerHTML = '';

      // Recebe todos os Key e dados em snapshotItem
  ...
  initEventsLi(li) {
    ...
    li.addEventListener('click', e => {
      ...
      // Se a tecla shift esta pressionada
      if (e.shiftKey) {
        ...
        if (firstLi) {
          ...
          // Busca o elemento-pai da li e corre todos os elementos filhos deste pai um a um
          lis.forEach((el, index) => {

            // Condicional para confirmar se o primeiro li é idêntico a o el do foreach
